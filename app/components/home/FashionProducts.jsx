      ...
      <div className="pb-28">
        ...
        <div className="relative overflow-hidden">
          <div className="flex items-center justify-between gap-x-3 w-full absolute top-1/2 -translate-y-1/2 z-20">
            <button
              className={`fashion-prev h-8 lg:h-11 w-8 lg:w-11 duration-300 bg-secondary flex justify-center items-center cursor-pointer ${
            ...
            <button
              className={`fashion-next h-8 lg:h-11 w-8 lg:w-11 duration-300 bg-secondary flex justify-center items-center cursor-pointer ${
                isEnd && "invisible"
              }`}
            >
